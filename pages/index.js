...
function	Index({hasSecret}) {
	...
	return (
		<section className={'w-full space-y-12 mb-64 z-10 relative'}>
			...
			{hasSecret ? (
				<div className={'flex justify-center items-center'}>
					<div className={'w-full max-w-5xl'}>
						<div className={'mt-4 hidden lg:flex justify-center items-center flex-col self-center absolute w-full max-w-5xl'}>
							<div className={'flex justify-center items-center flex-col group cursor-pointer'}>
								<p className={'text-white font-medium text-sm group-hover:underline cursor-pointer pt-2'}>{'Hi !'}</p>
							</div>
						</div>
					</div>
				</div>
